...
BG_COLOR = (193, 0, 48) # cor de fundo (um tom escuro)
#Carregar a imagem
image_file "GAME\\player.png" # Coloque o nome correto da sua imagem aqui
if os.path.exists(image_file):
ing pygame.image.load(image_file).convert_alpha() # Carregar a imagem
...
if current_width 1/z = last_width or current_height != last_height:
...
if keys [pygame.K_UP]:
img rect.y- SPEED # Move para cima
if keys [pygame.K_DOWN]:
ing rect.y + SPEED # Move para baixo
Preencher o fundo
screen.fill(BG_COLOR)
# Desenhar a imagem na tela
screen.blit(ing, img rect.topleft)
Atualizar a tela
pygame.display.flip()
#Finalizar o Pygane
pygase.quit()
